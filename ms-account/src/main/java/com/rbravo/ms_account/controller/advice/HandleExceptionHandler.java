package com.rbravo.ms_account.controller.advice;

import com.rbravo.ms_account.common.dto.ApiError;
...
public class HandleExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAccountNotFound(Exception ex) {
        List<String> details = new LinkedList<>();
        details.add(ex.getMessage());
        ApiError err = new ApiError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Account not found", details);
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(err);
    }

    @ExceptionHandler(InsufficientBalanceException.class)
    public ResponseEntity<Object> handleInsufficientBalance(Exception ex) {
        List<String> details = new LinkedList<>();
        details.add(ex.getMessage());
        ApiError err = new ApiError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Account insufficient balance", details);
